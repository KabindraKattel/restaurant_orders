...
import 'package:restaurant_orders/pages/open_orders/open_order_item_page.dart';
      ...
      children: [
        Padding(
          ...
          child: ModelPagedGridView<
            ...
            items: widget.model.entries.toList(),
